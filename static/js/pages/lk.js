const type = document.getElementsByClassName("mainHeader")[0].getAttribute("name");
const id = document.getElementsByClassName("mainHeader")[0].getAttribute("id");
...
switch (type) {
    ...
    case "lecturer":
        ...
        inputI = document.getElementById("inputI");
        inputO = document.getElementById("inputO");
        inputInst = document.getElementById("inputInst");
        break;
    case "admin":
        break;
}
